...
p5 = Planet.create({name: 'Jupiter', typeofplanet: 'Terrestrial', size: 6371, distancefromsun: 1, lengthofyear: 365.25, description: ''})
p6 = Planet.create({name: 'Saturn', typeofplanet: 'Terrestrial', size: 6371, distancefromsun: 1, lengthofyear: 365.25, description: ''})
p7 = Planet.create({name: 'Neptune', typeofplanet: 'Terrestrial', size: 6371, distancefromsun: 1, lengthofyear: 365.25, description: ''})
p8 = Planet.create({name: 'Uranus', typeofplanet: 'Terrestrial', size: 6371, distancefromsun: 1, lengthofyear: 365.25, description: ''})
